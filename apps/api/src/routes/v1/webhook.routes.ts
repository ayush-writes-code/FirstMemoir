...
import { shiprocketWebhookController } from '../../controllers/shiprocket.webhook.controller.js';
...
webhookRouter.post('/shiprocket', shiprocketWebhookController.handleShiprocketWebhook);
