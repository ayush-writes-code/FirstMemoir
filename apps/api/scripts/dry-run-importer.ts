...
async function run() {
  ...
  for (const category of categories) {
    ...
    for (const item of subitems) {
      ...
      const isGroupFolder = ['F&F cars (8 variations)', 'Football jerseys (10 variations)', 'Motivations Quotes (30 variations)', 'Anime (4 variations)', 'Car split (7 variations)', 'Ronaldo Split (6 variations)', 'Split Anime (7 variations)', 'bookmarks (3, 3 variations)'].includes(item);
  ...
  console.log(`- READY: ${totalFolders - missingData - businessConfirmation}`);
